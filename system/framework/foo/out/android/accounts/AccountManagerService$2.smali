...
.method constructor <init>(Landroid/accounts/AccountManagerService;Landroid/accounts/IAccountManagerResponse;Ljava/lang/String;ZZLjava/lang/String;[Ljava/lang/String;Landroid/os/Bundle;Ljava/lang/String;)V
    ...
    iput-object p6, p0, Landroid/accounts/AccountManagerService$2;->val$authTokenType:Ljava/lang/String;

    iput-object p7, p0, Landroid/accounts/AccountManagerService$2;->val$requiredFeatures:[Ljava/lang/String;

    iput-object p8, p0, Landroid/accounts/AccountManagerService$2;->val$options:Landroid/os/Bundle;

    iput-object p9, p0, Landroid/accounts/AccountManagerService$2;->val$accountType:Ljava/lang/String;
...
.method public run()V
    ...
    iget-object v2, p0, Landroid/accounts/AccountManagerService$2;->mAccountType:Ljava/lang/String;

    iget-object v3, p0, Landroid/accounts/AccountManagerService$2;->val$authTokenType:Ljava/lang/String;

    iget-object v4, p0, Landroid/accounts/AccountManagerService$2;->val$requiredFeatures:[Ljava/lang/String;

    iget-object v5, p0, Landroid/accounts/AccountManagerService$2;->val$options:Landroid/os/Bundle;
...
.method protected toDebugString(J)Ljava/lang/String;
    ...
    iget-object v1, p0, Landroid/accounts/AccountManagerService$2;->val$accountType:Ljava/lang/String;
    ...
    iget-object v1, p0, Landroid/accounts/AccountManagerService$2;->val$requiredFeatures:[Ljava/lang/String;

    if-eqz v1, :cond_3a

    const-string v1, ","

    iget-object v2, p0, Landroid/accounts/AccountManagerService$2;->val$requiredFeatures:[Ljava/lang/String;
