...
# direct methods
.method constructor <init>(Landroid/accounts/AccountManagerService;Landroid/accounts/IAccountManagerResponse;Ljava/lang/String;ZZLandroid/os/Bundle;Landroid/accounts/Account;Ljava/lang/String;ZZI)V
    .registers 12
    .parameter
    .parameter "x0"
    .parameter "x1"
    ...
    iput-object p6, p0, Landroid/accounts/AccountManagerService$1;->val$loginOptions:Landroid/os/Bundle;

    iput-object p7, p0, Landroid/accounts/AccountManagerService$1;->val$account:Landroid/accounts/Account;

    iput-object p8, p0, Landroid/accounts/AccountManagerService$1;->val$authTokenType:Ljava/lang/String;

    iput-boolean p9, p0, Landroid/accounts/AccountManagerService$1;->val$notifyOnAuthFailure:Z

    iput-boolean p10, p0, Landroid/accounts/AccountManagerService$1;->val$permissionGranted:Z

    iput p11, p0, Landroid/accounts/AccountManagerService$1;->val$callerUid:I
...
.method public onResult(Landroid/os/Bundle;)V
    ...
    iget v2, p0, Landroid/accounts/AccountManagerService$1;->val$callerUid:I
    ...
    iget-object v4, p0, Landroid/accounts/AccountManagerService$1;->val$authTokenType:Ljava/lang/String;
    ...
    .line 861
    invoke-virtual {p0, v7}, Landroid/accounts/AccountManagerService$1;->onResult(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/accounts/AccountManagerService$1;->onError(ILjava/lang/String;)V
    ...
    iget-object v2, p0, Landroid/accounts/AccountManagerService$1;->val$authTokenType:Ljava/lang/String;
    ...
    iget-boolean v0, p0, Landroid/accounts/AccountManagerService$1;->val$notifyOnAuthFailure:Z
...
.method public run()V
    ...
    .prologue
    .line 845
    iget-boolean v0, p0, Landroid/accounts/AccountManagerService$1;->val$permissionGranted:Z
    ...
    iget-object v3, p0, Landroid/accounts/AccountManagerService$1;->val$loginOptions:Landroid/os/Bundle;
...
.method protected toDebugString(J)Ljava/lang/String;
    ...
    .prologue
    .line 834
    iget-object v0, p0, Landroid/accounts/AccountManagerService$1;->val$loginOptions:Landroid/os/Bundle;
    ...
    iget-object v1, p0, Landroid/accounts/AccountManagerService$1;->val$loginOptions:Landroid/os/Bundle;
    ...
    iget-boolean v1, p0, Landroid/accounts/AccountManagerService$1;->val$notifyOnAuthFailure:Z
